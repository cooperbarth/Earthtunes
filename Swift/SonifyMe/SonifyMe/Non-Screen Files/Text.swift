...
let eventOneDescription = "Magnitude 5.0 Earthquake in Oklahoma"
let eventTwoDescription = "Sunny Day at Ryerson Station"
let eventThreeDescription = "Magnitude 5.8 Earthquake in Montana"
let eventFourDescription = "Magnitude 5.4 Earthquake in Hawaii"
let eventFiveDescription = "Students went to Ryerson station and jumped on the ground near the seismometer. See if you can find a frequency at which you can hear it!"
let eventSixDescription = "Thunderstorm at Ryerson Station"
